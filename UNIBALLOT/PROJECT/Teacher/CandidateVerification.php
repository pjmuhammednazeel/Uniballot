...
<body>
<?php
$selQry = "select * from tbl_election e inner join tbl_assignelectionteacher a on e.election_id = a.election_id inner join tbl_candidate  c on a.batch_id = c.batch_id inner join tbl_user u on u.user_id = c.user_id where a.teacher_id = ".$_SESSION['etid'];
  ...
  <table width="1000" border="1">
    ...
    <?php
      ...
      <tr>
        ...
        <td><a href="CandidateVerification.php?aid=<?php echo $row["candidate_id"]?>">Accept</a><a href="CandidateVerification.php?rid=<?php echo $row["candidate_id"]?>">Reject</a></td>
